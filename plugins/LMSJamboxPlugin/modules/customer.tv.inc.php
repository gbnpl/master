...
$SMARTY->assignByRef('cust_data', $cust_data);

$SMARTY->assignByRef('customertvjamboxaccounts', $customertvjamboxaccounts);
$SMARTY->assignByRef('accblockednum', $accblockednum);

$SMARTY->assignByRef('subnetlist', $subnetlist);
