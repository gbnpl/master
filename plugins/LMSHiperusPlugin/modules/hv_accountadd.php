...
if ( isset($_POST['accountadd']) ) {
	...
	$dane['payment_type'] = 'postpaid';
	$dane['invoice'] = ConfigHelper::getConfig('hiperus_c5.invoice_source', 0);
}

$SMARTY->assign('voip_to_lms', ConfigHelper::getConfig('hiperus_c5.force_relationship'));
$SMARTY->assign('dane',$dane);
$SMARTY->assign('wlr', ConfigHelper::getConfig('hiperus_c5.wlr'));
