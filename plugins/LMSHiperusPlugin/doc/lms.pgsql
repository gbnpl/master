CREATE TYPE hv_bool AS ENUM ('f', 't');
CREATE TYPE hv_payment_type AS ENUM ('prepaid', 'postpaid');
...
CREATE TABLE hv_customers (
  ...
  issue_invoice hv_bool NOT NULL DEFAULT 'f',
  id_default_pricelist integer DEFAULT NULL,
  id_default_balance integer DEFAULT NULL,
  payment_type hv_payment_type NOT NULL DEFAULT 'postpaid',
  is_wlr hv_bool NOT NULL DEFAULT 'f',
  active hv_bool NOT NULL DEFAULT 't',
  create_date varchar(30) DEFAULT NULL,
  consent_data_processing hv_bool NOT NULL DEFAULT 'f',
  platform_user_add_stamp varchar(50) DEFAULT NULL,
  open_registration hv_bool NOT NULL DEFAULT 'f',
  is_removed hv_bool NOT NULL DEFAULT 'f',
  PRIMARY KEY (id)
);
...
CREATE TABLE hv_billing (
  ...
  bill_cpb varchar(20) DEFAULT NULL,
  ...
  init_charge numeric(12,4) NOT NULL DEFAULT 0,
  reseller_price numeric(12,4) NOT NULL DEFAULT 0,
  reseller_cost numeric(12,4) NOT NULL DEFAULT 0,
  reseller_init_charge numeric(12,4) NOT NULL DEFAULT 0,
  margin numeric(12,4) NOT NULL DEFAULT 0,
  subscription_used hv_bool DEFAULT NULL,
  platform_type varchar(20) DEFAULT NULL,
  success_call hv_bool DEFAULT NULL,
  PRIMARY KEY (id)
);
...
CREATE TABLE hv_pricelist (
  ...
  charge_internal_call hv_bool NOT NULL DEFAULT 'f',
  PRIMARY KEY (id)
);
...
CREATE TABLE hv_enduserlist (
  ...
  email varchar(255) DEFAULT NULL,
  admin hv_bool NOT NULL DEFAULT 't',
...
CREATE TABLE hv_pstn (
  ...
  country_code varchar(3) NOT NULL DEFAULT '48',
  number varchar(20) DEFAULT NULL,
  is_main hv_bool NOT NULL DEFAULT 't',
  disa_enabled hv_bool NOT NULL DEFAULT 'f',
  clir hv_bool NOT NULL DEFAULT 'f',
  virtual_fax hv_bool NOT NULL DEFAULT 'f',
  terminal_name varchar(100) DEFAULT NULL,
  id_auth integer DEFAULT NULL,
  create_date varchar(30) DEFAULT NULL,
  voicemail_enabled hv_bool NOT NULL DEFAULT 't',
  PRIMARY KEY (id)
);
...
CREATE TABLE hv_pstnrange (
  ...
  open_registration hv_bool NOT NULL DEFAULT 'f',
  ussage hv_bool NOT NULL DEFAULT 't',
  PRIMARY KEY (id)
);
...
CREATE TABLE hv_province (
  id integer DEFAULT nextval('hv_province_id_seq'::text) NOT NULL,
  name char(20) NOT NULL DEFAULT '',
  PRIMARY KEY (id),
  UNIQUE (name)
);

CREATE SEQUENCE hv_county_id_seq;
CREATE TABLE hv_county (
  id integer DEFAULT nextval('hv_county_id_seq'::text) NOT NULL,
  name varchar(50) NOT NULL DEFAULT '',
  PRIMARY KEY (id),
  UNIQUE (name)
);

CREATE SEQUENCE hv_borough_id_seq;
CREATE TABLE hv_borough (
  id integer DEFAULT nextval('hv_borough_id_seq'::text) NOT NULL,
...
SELECT setval('hv_assign_id_seq', (SELECT MAX(id) FROM hv_assign));
SELECT setval('hv_province_id_seq', (SELECT MAX(id) FROM hv_province));
