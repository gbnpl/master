...
$text = '';
require_once PLUGINS_DIR . DIRECTORY_SEPARATOR . LMSHiperusPlugin::plugin_directory_name
	. DIRECTORY_SEPARATOR . 'lib' . DIRECTORY_SEPARATOR . 'mpdf' . DIRECTORY_SEPARATOR . 'mpdf.php';
...
$text = $SMARTY->fetch('hv_billinginfoext_print.html');
